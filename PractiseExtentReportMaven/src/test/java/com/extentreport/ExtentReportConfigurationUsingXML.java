...
public class ExtentReportConfigurationUsingXML {
	...
	public static void main(String[] args) throws IOException {
		...
		SparkReporter.loadXMLConfig(new File("C:\\JAVA_PRACTISE\\Git_Practise\\PractiseExtentReportMaven\\src\\test\\resources\\extentreport-config.xml"));
		...
		extentreports.createTest("Configuration xml","Configuration information")
		.assignAuthor("anji")
